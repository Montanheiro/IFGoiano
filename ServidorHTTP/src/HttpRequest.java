	...
	BufferedReader br = new BufferedReader(new InputStreamReader(is));
        ...
        if(fileName.endsWith(caminho + "/")){
        	...
        	if(indexhtm.exists()){
        		...
        		System.out.println("O sistema não encontrou o arquivo index!");
        	}
        	if(indexhtm.exists() || indexhtml.exists()){
        		System.out.println("O sistema definiu index como página padrão.");
        		fis = new FileInputStream(fileName);
            	fileExists = true;
        	}
        }        
